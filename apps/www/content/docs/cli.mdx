...
```txt
Usage: beingofexistence-dx init [options]
...
```bash
npx beingofexistence-dx@latest add [component]
```
...
```txt
Usage: beingofexistence-dx add [options] [components...]
...
```txt
Usage: beingofexistence-dx diff [options] [component]
